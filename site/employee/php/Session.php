...
class Session {
    ...
    public static function refreshSession( $refreshToken ) : bool {
        ...
        $sqlQuery = 
            'SELECT ' .
                'employee_account_sessions.id, ' .
                'employee_account_sessions.employee_account_id, ' .
                'employee_account_sessions.company_id, ' .
                'employee_account_sessions.refresh_token, ' .
                'employee_account_sessions.lifetime, ' .
                'employee_account_sessions.last_accessed_on, ' .
                'employee_accounts.first_name AS name, ' .
            ...
            'FROM ' .
                'employee_account_sessions ' .
            'LEFT JOIN ' .
                'employee_accounts ON employee_accounts.id = employee_account_sessions.employee_account_id ' .
            'LEFT JOIN ' .
                'employee_account_employee_profile_access ON employee_account_employee_profile_access.employee_account_id = employee_account_sessions.employee_account_id ' .
            'LEFT JOIN ' .
            ...
            'WHERE ' .
                '(employee_profiles.company_id = employee_account_sessions.company_id OR employee_profiles.company_id IS NULL) AND ' . 
                'refresh_token = $1;';
        ...
        // Does the employe have a profile?
        $hasProfile = false;
        if( $sqlRow['company_id'] !== null ) {
            $hasProfile = true;
        }
        ...
        $sqlQuery = 'UPDATE employee_account_sessions SET last_accessed_on = $1 WHERE id = $2;';
