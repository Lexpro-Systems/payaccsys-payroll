...
//
app.panel.EditPayrunDescription = function(config) {
    ...
    function loadPayrunDescription() {
        lx.sendJSON({
            ...
            onSuccess: function( responseText ) {
                ...
                payrunDescriptionTxt.setValue(response.payrunDescription);
            }
        });
    }
    ...
    me.init = function( config ) {
        ...
        lx.createElement('DIV', {
            ...
            innerHTML: 'Edit Payrun Description'
        });
        ...
        // Create the payrunDescriptionTxt component
        payrunDescriptionTxt = new lx.component.Textbox({
            renderTo: payrunDetailsSectionEl,
            label: 'Payrun Description'
        });
    ...
    function editBtnClickEventHandler() {
        if( payrunDescriptionTxt.getValue() === '' ) {
            editBtn.showWarning('Please enter the payrun name');
        ...
        lx.sendJSON({
            url: 'exec.php?c=Payrun&fn=editDescription',
            data: {
                payrunId: config.payrunId,
                payrunDescription: payrunDescriptionTxt.getValue().trim()
            },
            onSuccess: function( responseText ) {
                ...
                me.fireEvent('save', {
                    ...
                    payrunName: payrunDescriptionTxt.getValue().trim()
                });
            }
        });
    }
