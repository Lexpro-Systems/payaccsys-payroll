...
// Events:
//
//  onLogin             This event is fired after successfully logging in
//  onCancel            This event is fired when the user click the cancel button
//  onDestroy           This event is fired just before the component is destroyed.
//
app.panel.LexproAccountingLogin = function(config) {
    ...
    me.init = function( config ) {
        ...
        lx.createElement('DIV', {
            ...
            innerHTML: 'Lexpro Accounting Login'
        });
        ...
        // Create the booksetTxt component
        booksetTxt = new lx.component.Textbox({
    ...
    function loginBtnClickEventHandler() {
        ...
        loginBtn.disable();
        lx.sendJSON({
            url: 'exec.php?c=LexproAccounting&fn=connect',
            data:{
                bookset: booksetTxt.getValue(),
