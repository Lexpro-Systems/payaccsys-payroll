...
// EXPORT RECONCILIATION EXCEPTIONS PANEL
//
// Config:
...
//
app.panel.ExportReconciliationExceptions = function(config) {
    ...
    me.init = function( config ) {
        ...
        lx.createElement('DIV', {
            ...
            innerHTML: 'Export Reconciliation Exceptions'
        });
        ...
        // Create formatRadio component
        formatRadio = new lx.component.RadioGroup({
            renderTo: reconciliationDetailsSectionEl,
            margin: '0px 0px 0px 0px',
            label: 'Export Format',
            
            items: app.commonSelectOptions.formatTypes
        });
        formatRadio.setValue('xls');
    ...
    function exportBtnClickEventHandler() {
        ...
        lx.sendForm({
            url: 'exec.php?c=TaxReconciliation&fn=exportExceptions',
            target: '_self',
            data: {
                exceptions: exceptions,
                format: formatRadio.getValue()
            }
        });
