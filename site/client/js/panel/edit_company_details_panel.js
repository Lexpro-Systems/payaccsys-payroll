...
//
app.panel.EditCompanyDetails = function(config) {
    ...
    var companyRegistrationNumberTxt = null;
    ...
    function loadCompanyDetails() {
        ...
        lx.sendJSON({
            ...
            onSuccess: function( responseText ) {
                ...
                companyRegistrationNumberTxt.setValue(response.company.details.registrationNumber);
    ...
    me.init = function( config ) {
        ...
        lx.createElement('DIV', {
            ...
            innerHTML: 'Edit Company Details'
        });
        ...
        // Create the companyRegistrationNumberTxt component
        companyRegistrationNumberTxt = new lx.component.Textbox({
            renderTo: companyDetailsSectionEl,
    ...
    function saveBtnClickEventHandler() {
        ...
        companyRegistrationNumberTxt.validate();
        
        // Check that a valid company name was entered.
        if( companyNameTxt.getValue() === '' ) {
            saveBtn.showWarning('Your company name can not be empty.');
            return;
        }
        
        // Check that a valid company alias was entered.
        if( companyAliasTxt.getValue() === '' ) {
            saveBtn.showWarning('Your company alias can not be empty.');
            return;
        }
        
        // Check that a valid company alias was entered.
        if( companyRegistrationNumberTxt.getValue() === '' ) {
            saveBtn.showWarning('Your company registration number can not be empty.');
            return;
        }
        ...
        lx.sendJSON({
            ...
            data: {
                name: companyNameTxt.getValue(),
                alias: companyAliasTxt.getValue(),
                registrationNumber: companyRegistrationNumberTxt.getValue()
            },
            onSuccess: function( responseText ) {
