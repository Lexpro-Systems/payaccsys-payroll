...
app.panel.Attendance = function(config) {
       ...
       // alert('demo ' + savedTag);
        ...
        lx.sendJSON({
            ...
            onSuccess: function( responseText ) {
                ...
                for( let i = 0; i < response.attendance.employees.length; i++ ) {
    ...
    me.init = function( config ) {
        ...
        // Initialize the tag selection on page load
        //initializeTagSelection();
        ...
        // Load the tags and initialize the selection
        loadTags();
    ...
    function addVisitorBtnClickEventHandler () {
        let signInVisitorModal = new lx.component.ModalWindow({
            margin: '40px',
            maxWidth: '450px',
            maxHeight: '528px'
        });
        ...
        let signInVisitorPanel = new app.panel.SignInVisitor({
    ...
    function historyBtnClickEventHandler () {
        ...
        let listAttendanceHistoryPanel = new app.panel.ListAttendanceHistory({
            renderTo: app.mainPanel.getContainer(),
            show: true,
            
            onDestroy: function( event ) {
                if( event.refreshAttendance == true ) {
