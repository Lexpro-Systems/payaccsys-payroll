...
// EDIT LEAVE REQUEST ADMIN DETAILS PANEL
//
// Config:
...
//
app.panel.EditLeaveRequestAdminDetails = function(config) {
    ...
    var leaveRequestAdminDetailsSectionEl = null;
    ...
    me.init = function( config ) {
        ...
        leaveRequestAdminId = compConfig.leaveRequestAdminId;
        ...
        lx.createElement('DIV', {
            ...
            innerHTML: 'Edit Leave Request Administrator Details'
        });
        ...
        leaveRequestAdminDetailsSectionEl = lx.createElement('DIV', {
            parent: contentEl,
            style: {
                backgroundColor: '#FFFFFF',
                borderStyle: 'solid',
        ...
        emailAddressTxt = new lx.component.Textbox({
            renderTo: leaveRequestAdminDetailsSectionEl,
            label: 'Email Address'
        });
        if( compConfig.emailAddress !== '-' ) {
            emailAddressTxt.setValue( compConfig.emailAddress );
        }
    ...
    function saveBtnClickEventHandler() {
        ...
        lx.sendJSON({
            ...
            data: {
                leaveRequestAdminEmailAddress: emailAddressTxt.getValue().trim()
            },
