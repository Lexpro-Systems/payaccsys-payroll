...
//
app.panel.OvertimeReport = function(config) {
    ...
    function loadReport() {
        ...
        // Get the report data
        lx.sendJSON({
            url: 'exec.php?c=Report&fn=getOvertimeList',
            data: {
    ...
    function exportExcelBtnOnClickEventHandler () {
        ...
        lx.sendForm({
            url: 'exec.php?c=Report&fn=runOvertimeReport',
            target: '_self',
            data: {
                format: 'xls',
                detail: filterDetailRadio.getValue(),
    ...
    function exportPdfBtnOnClickEventHandler () {
        ...
        lx.sendForm({
            url: 'exec.php?c=Report&fn=runOvertimePdfReport',
            target: '_blank',
            data: {
                detail: filterDetailRadio.getValue(),
                filterType: filterTypeRadio.getValue(),
