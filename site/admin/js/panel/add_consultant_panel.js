...
//
app.panel.AddConsultant = function(config) {
    ...
    function addBtnClickEventHandler() {
        if( consultantNameTxt.getValue() === '' ) {
            addBtn.showWarning('Please enter the consultant name');
            return;
        }
        ...
        lx.sendJSON({
            url: 'exec.php?c=Consultant&fn=add',
            data: {
