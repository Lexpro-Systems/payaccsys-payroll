<?php
    ...
    class Attendance extends Controller {
        ...
        //
        // Required Parameters
        //  id                          The id of the attendance item to remobe
        ...
        public function getList($data, $user, $db) {
            ...
            if( ($data['startDate'] !== null) || ($data['endDate'] !== null) ) {
                ...
                if( $data['endDate'] === null ) {
                    $whereClause = $whereClause . 'time_in::Date >= \'' . $data['startDate'] . ' 00:00:00\' ';
                }
                else if( $data['startDate'] === null ) {
                    $whereClause = $whereClause . 'time_in::Date <= \'' . $data['endDate'] . ' 23:59:59\' ';
                }
                else {
        ...
        // Optional Parameters
        //  None
        public function updateEmployeeAttendance($data, $user, $db) {
            // Set content type header
            header('Content-Type: application/json');
            ...
            if( $sqlResult->getRowCount() !== 1 || $timeOut !== null) {
                $sqlQuery = 
                    'INSERT INTO employee_attendance ( '.
                        'employee_id, ' .
                        'time_in, ' .
