...
// console.log(attendanceGrid.getRow(clickEvent.rowIndex));
                    var viewAttendanceModal = new lx.component.ModalWindow({
                        margin: '40px',
                        maxWidth: '450px',
                        maxHeight: '541px'
                    });
                    ...
                    var viewAttendancePanel = new app.panel.ViewAttendance({
                    ...
                    new lx.component.Messagebox({
                        title: 'Remove Payrun',
                        message: 
                            'Are you certain you wish to permanently remove this attendance entry?',
                        buttons: [
    ...
    function attendanceGridCellClickEventHandler( event ) {
        if( event.columnIndex === 1 ) {
            ...
            new lx.component.Messagebox({
                title: 'Unable Edit Employee',
                message: 'Only visitor details may be edited from here. Please login to Lexpro Payroll to edit employee details.'
            });
